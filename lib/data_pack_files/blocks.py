    ...
    if pack_version <= 1202:
        ...
        if read and data_value == -1:
            ...
            if "#tag_replacements" in block_id:
                MK.printColored("Tag replacement data pack must be created!","LIGHT_RED")
        ...
        # Blocks specified with explicit block states
            ...
            if defaults.SEND_WARNINGS:
                MK.printColored("WARNING: Data values specified as block states are not supported yet!","LIGHT_RED")
