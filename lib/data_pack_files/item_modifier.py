        ...
        for operation in contents["ops"]:
            ...
            if target_path[0] == "minecraft:custom_data":
                ...
                if defaults.SEND_WARNINGS:
                    MK.printError(f'WARNING: Item modifier function "minecraft:copy_nbt" could not be converted to "minecraft:copy_components", target path changed to: {operation["target"]}')
